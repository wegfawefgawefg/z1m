...
inline constexpr float kShootAlignThreshold = 9.0F / 16.0F;
inline constexpr float kWandererTargetThreshold = 9.0F / 16.0F;
inline constexpr float kGoriyaTargetThreshold = 81.0F / 16.0F;
inline constexpr float kGridCenterTolerance = 0.12F;
inline constexpr float kRopeRushAlignThreshold = 0.75F;
inline constexpr float kArmosWakeRadius = 0.80F;
inline constexpr float kLeeverSpawnOffset = 5.0F;
inline constexpr float kWallmasterEdgeThreshold = 1.0F;
inline constexpr float kWallmasterTravelTiles = 7.0F;
...
inline constexpr float kGohmaSpeed = 2.0F;
